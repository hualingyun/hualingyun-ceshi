...
<body>
    <div class="sidebar">
        ...
        <a href="my_records.php" class="active">我的交接记录</a>
    </div>

    <div class="main-content">
        <div class="top-bar">
            <span class="fs-5">我的交接记录</span>
            <div>
        ...
        async function loadRecords(page = 1) {
            ...
            if (data.success) {
                if (data.data.length === 0) {
                    document.getElementById('record-list').innerHTML = '<tr><td colspan="8" class="text-center text-muted">暂无记录</td></tr>';
                } else {
